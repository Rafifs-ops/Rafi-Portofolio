            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5 text-center text-lg-start text-white">
                    ...
                    <div
                        ...
                        <div class="icon-circle me-3"><img src="/logos/email.png" class="icon-img"></div>
                    ...
                    <div
                        ...
                        <div class="icon-circle me-3"><img src="/logos/location.png" class="icon-img"></div>
                        <span>Jakarta, Indonesia</span>
                    </div>

                    <div class="social-links mt-4">
                        <a href="https://instagram.com/rafi.febrian.suprapto" class="social-icon"><img
                                src="/logos/ig.png" class="icon-img" target="_blank"></a>
                        <a href="https://wa.me/62895383151668" class="social-icon" target="_blank"><img
                                src="/logos/wa.png" class="icon-img"></a>
                        <a href="https://www.linkedin.com/in/rafi-febrian-suprapto-8a9a42312" class="social-icon"
                            target="_blank"><img src="/logos/linkedin.png" class="icon-img"></a>
                    </div>
                </div>
